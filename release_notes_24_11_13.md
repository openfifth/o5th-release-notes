...
This release includes 21 enhancements, 25 bugfixes.
...
- [40737](https://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=40737) Usage statistics data provider "Import logs" table does not render if "Imported by": "Cronjob" [25.05]
...
- [40105](https://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=40105) Patrons cannot add notes when creating an ILL
  - **Backported from version(s):** 26.05.00,25.11.04
...
- [OpenFifth](https://openfifth.co.uk) (98)
...
*Generated by Open Fifth release tools on 29 Apr 2026 10:27:57*
